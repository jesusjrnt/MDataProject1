...
host = 'localhost'
base_datos = 'database'  # Reemplaza con el nombre de tu base de datos en phpMyAdmin

# Crea la cadena de conexión a la base de datos usando sqlalchemy
cadena_conexion = f"mysql+mysqlconnector://dataproject:dataproject@localhost/database"
